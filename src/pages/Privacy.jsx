...
export default function Privacy() {
  ...
  const tableData = [
    {
      purpose: "предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте",
      personalData: [
      ...
      legalBasis: "уставные (учредительные) документы Оператора",
      processingTypes: [
  ...
  return (
    <div className='flex flex-col min-h-screen mx-auto'>
      ...
      <div className='max-w-4xl mx-auto p-4 flex flex-col text-left break-all'>
        <h1 className='text-2xl font-bold mb-4'>Политика в отношении обработки персональных данных</h1>
        <ol className='list-decimal ml-4 space-y-4'>
          <li>
            ...
            <p className='mt-2'>
              ...
              предпринимаемые ИП Пермякова Ульяна Александровна (далее — Оператор).
            </p>
              ...
              <li>
                <p>
                  ...
                  <a
                    ...
                    href='http://unodrive.online/'
                    target='_blank'
                    rel='noopener noreferrer'>
                    http://unodrive.online/
                  </a>
                  .
                </p>
              </li>
          ...
          <li>
            <h2 className='text-xl font-semibold'>Основные понятия, используемые в Политике</h2>
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Веб-сайт</strong> — совокупность графических и информационных материалов, а также программ для
              ...
              <li>
                <p>
                  <strong>Трансграничная передача персональных данных</strong> — передача персональных данных на
              ...
              <li>
                <p>
                  <strong>Уничтожение персональных данных</strong> — любые действия, в результате которых персональные
          ...
          <li>
            <h2 className='text-xl font-semibold'>Основные права и обязанности Оператора</h2>
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              <li>
                <p>
          ...
          <li>
            <h2 className='text-xl font-semibold'>Основные права и обязанности субъектов персональных данных</h2>
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              <li>
                <p>
          ...
          <li>
            <h2 className='text-xl font-semibold'>Принципы обработки персональных данных</h2>
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              <li>
          ...
          <li>
            <h2 className='text-xl font-semibold'>Цели обработки персональных данных</h2>
            <div className='mt-2'>
              {tableData.map((row, index) => (
                <div
                  ...
                  <div className='p-4 border-b border-gray-200'>
                    <h3 className='text-lg font-medium'>Цель обработки: {row.purpose}</h3>
                  </div>
                  <div className='flex flex-col md:flex-row'>
                    <div className='w-full md:w-1/2 p-4 border-b md:border-r md:border-b-0 border-gray-200'>
                      <h4 className='text-base font-medium mb-2'>Персональные данные:</h4>
                      <ul className='list-disc ml-5 text-sm'>
                        {row.personalData.map((item, idx) => (
                          <li key={idx}>{item}</li>
                        ))}
                      </ul>
                    </div>
                    <div className='w-full md:w-1/2 p-4'>
                      <div className='mb-4'>
                        <h4 className='text-base font-medium mb-2'>Правовые основания:</h4>
                        <p className='text-sm'>{row.legalBasis}</p>
                      </div>
                      <div>
                        <h4 className='text-base font-medium mb-2'>Виды обработки персональных данных:</h4>
                        <ul className='list-disc ml-5 text-sm'>
                          {row.processingTypes.map((item, idx) => (
                            <li key={idx}>{item}</li>
                          ))}
                        </ul>
                      </div>
          ...
          <li>
            <h2 className='text-xl font-semibold'>Условия обработки персональных данных</h2>
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              <li>
                <p>
            ...
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              ...
              <li>
                <p>
                  ...
                  <a
                    className='text-blue-500 underline'
                    href='mailto:unodrive.online@gmail.com'
                    target='_blank'
                    rel='noopener noreferrer'>
                    unodrive.online@gmail.com
                  </a>
              ...
              <li>
                <p>
                  Вся информация, которая собирается сторонними сервисами, в том числе платежными системами, средствами
                  связи и другими поставщиками услуг, хранится и обрабатывается указанными лицами (Операторами) в
                  соответствии с их Пользовательским соглашением и Политикой конфиденциальности. Субъект персональных
                  данных и/или с указанными документами. Оператор не несет ответственность за действия третьих лиц, в
                  том числе указанных в настоящем пункте поставщиков услуг.
                </p>
              </li>
              <li>
                <p>
                  Установленные субъектом персональных данных запреты на передачу (кроме предоставления доступа), а
          ...
          <li>
            <h2 className='text-xl font-semibold'>Трансграничная передача персональных данных</h2>
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              <li>
                <p>
                  Оператор до начала осуществления деятельности по трансграничной передаче персональных данных обязан
          ...
          <li>
            <h2 className='text-xl font-semibold'>Конфиденциальность персональных данных</h2>
            <p className='mt-2'>
            ...
            <ol className='list-decimal ml-6 mt-2 space-y-2'>
              ...
              <li>
                <p>
                  ...
                  <a
                    className='text-blue-500 underline'
                    href='http://unodrive.online/privacy/'
                    target='_blank'
                    rel='noopener noreferrer'>
                    http://unodrive.online/privacy/
                  </a>
                  .
                </p>
              </li>
