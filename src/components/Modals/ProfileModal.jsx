      ...
      <div className='flex flex-col items-start justify-start w-full '>
        <div className='flex gap-2 mb-10 text-left mx-5'>
          ...
          <div>
            ...
            <p className='text-[#9D9D9D] text-[16px]'> Рейтинг {selectedDriver.rating}/5</p>
                  ...
                  <>
                    <svg
                      ...
                      <path
                        ...
                        fill={Math.floor(selectedDriver.rating) <= i ? "#E8E8E8" : "#FBC02D"}
                      />
                    </svg>
                  </>
                );
        ...
        <div className='flex flex-col w-full justify-center items-center'>
          ...
          <div className='mt-8 flex gap-5 flex-col w-full items-center'>
            {selectedDriver.comments.map((com, i) => {
              return (
                <ReviewCard
                  key={i}
                  review={com}
